...
export const WARNINGS = [
  ...
  W('k25', (v) => v.k25 < 0.7, (v) => `2025 年支出分摊系数只有 ${(v.k25 * 100).toFixed(1)}%："支出调整"规则下，各项支出都要按计划的这个比例执行，压减幅度已经很大。`),
  W('k25', (v) => v.k25 > 1.3, (v) => `2025 年支出分摊系数达 ${(v.k25 * 100).toFixed(1)}%：多收的钱按同一比例分给各项，各项都超计划。`, 'info'),
